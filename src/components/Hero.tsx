  ...
  return (
    <div className="relative h-screen">
      <div className="absolute inset-0">
        {/* Fallback Image */}
        <div className={`absolute inset-0 transition-opacity duration-1000 ${isVideoLoaded && !isVideoError ? 'opacity-0' : 'opacity-100'}`}>
          <img 
        ...
        {/* Video Background - Now enabled for all devices */}
        <video
          ref={videoRef}
